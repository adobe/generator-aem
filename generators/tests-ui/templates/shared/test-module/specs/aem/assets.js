...
describe('AEM Assets', () => {
  ...
  it('should be possifble to upload an asset', () => {
    ...
    const handle = browser.getFileHandleForUpload(path.join(__dirname, '..', '..', 'assets', imageName));
    ...
    // Deconste Asset
    browser.AEMDeconsteAsset(imagePath);
